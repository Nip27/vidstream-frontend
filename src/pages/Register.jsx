    ...
    <div style={{
      ...
      <div className="fade-up" style={{ width: '100%', maxWidth: 480 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 28, marginBottom: 6 }}>Join ChaiTube</h1>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 4 }}>
              <label htmlFor="avatar-input" style={{ cursor: 'pointer' }}>
                ...
                <input id="avatar-input" type="file" accept="image/*" style={{ display: 'none' }} onChange={e => handleFile(e, 'avatar')} />
              </label>
              <div>
                <div style={{ fontSize: 14, fontWeight: 500 }}>Profile Photo</div>
                <div style={{ fontSize: 12, color: 'var(--text-3)' }}>Required · Click to upload</div>
              </div>
            </div>
            ...
            <div className="input-group">
              <label>Cover Image <span style={{ color: 'var(--text-3)', fontWeight: 400 }}>(optional)</span></label>
              <input className="input" type="file" accept="image/*" style={{ padding: '10px 12px' }}
